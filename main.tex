  ...
  \resumeSubHeadingListStart
    \resumeSubheading
        ...
        \resumeItemListStart
            ...
            \resumeItem{Thesis Committee: Lisa Kaltenegger (\textit{chair}), Jake Turner, Drummond Fielding, and Megan Holycross}
        \resumeItemListEnd
...
\section{Manuscripts In Review}
    ...
    \textbf{M-Dwarf Exoplanets With Similar Sizes and Instellations to Earth Typically Follow Near-Circular Orbits.} \textit{—Kipping, D., Solano-Oropeza, D., Yahalomi, D., Poddar, A., Li, M., Zhang, A. (2024)} Accepted to Nature Astronomy, publication forthcoming.
